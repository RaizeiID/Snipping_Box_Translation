...
EXTRA_ENV = {'TITAN_NATURALIZE_MAX': '1', 'ORT_V5_LEVEL': '4', 'TITAN_ONLINE_ASSIST': '1'}
DEFAULT_INTERVAL = 260
...
def main():
    ...
    env.setdefault('ORT_MODEL_KEY', 'idn_v4')
    ...
    env.setdefault('ORT_BOOT_ENGINE', 'hybrid')
