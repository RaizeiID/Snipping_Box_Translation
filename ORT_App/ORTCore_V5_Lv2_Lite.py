...
TARGET = 'TITANMAIN.py'
MODEL_LABEL = 'ORTCore V5 Lv2 Lite'
EXTRA_ENV = {'TITAN_NATURALIZE_MAX': '1', 'ORT_V5_LEVEL': '2', 'TITAN_LITE_MODE': '1', 'TITAN_USE_LITE_POLICY': '1'}
DEFAULT_INTERVAL = 470
...
def main():
    ...
    env.setdefault('ORT_MODEL_KEY', 'lite_idn_v2')
