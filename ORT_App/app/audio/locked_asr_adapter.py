...
class LockedASRProviderAdapter:
    ...
    def _load_reazon(self) -> None:
        ...
        self.model, sherpa_info = create_offline_transducer(
        ...
        self.emit_event(
            "runtime",
            provider_id=self.provider_id,
            sherpa_onnx=sherpa_info.as_dict(),
            compatibility_alias=(
                sherpa_info.recognizer_source
    ...
    def _load_sensevoice(self) -> None:
        ...
        self.model, sherpa_info = create_offline_sense_voice(
