"""Replay OCR/Overlay comparison helper for ORT Translation v8.7.7.
...
def compare(truth_path:Path, result_paths:list[Path], out_path:Path):
    ...
    report={"tool":"ORT v8.7.7 Replay OCR & Overlay Benchmark","ground_truth":str(truth_path),"runs":[]}
...
def main():
    ...
    ap.add_argument("--out",default="status/v8_7_7_replay_benchmark.json")
    a=ap.parse_args()
