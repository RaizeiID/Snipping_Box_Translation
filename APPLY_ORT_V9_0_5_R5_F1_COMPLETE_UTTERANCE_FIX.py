...
PATCH_ID = "v9.0.5-R5-F1-COMPLETE-UTTERANCE-STREAMING"
...
def main() -> int:
    ...
    try:
        ...
        status_file = status_dir / "V9_0_5_R5_F1_COMPLETE_UTTERANCE.json"
        ...
        log("FIX SELESAI")
        print("ORT v9.0.5 R5-F1 Complete Utterance Streaming: PASS", flush=True)
