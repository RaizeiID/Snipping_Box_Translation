...
> **Status rilis:** ORT v9.0.0 — Open Architecture Foundation & Clean Project Layout  
> **Basis:** ORT v8.9.9 R2 F2  
...
```text
ORT\maintenance\VERIFY_ORT_V9_0_0.bat
```
...
```text
ORT Translation v9.0.0
Open Architecture Foundation & Clean Project Layout
```
