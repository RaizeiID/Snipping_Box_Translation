...
setlocal
chcp 65001 >nul
title ORT v9.0.5 R5 - Complete Utterance Streaming Fix

echo ============================================================
echo  ORT v9.0.5 R5 - Complete Utterance Streaming Fix
echo ============================================================
echo.
...
"%CPU_PYTHON%" "%ROOT%APPLY_ORT_V9_0_5_R5_COMPLETE_UTTERANCE_FIX.py" "%ROOT%"
set "EXIT_CODE=%ERRORLEVEL%"

echo.
if not "%EXIT_CODE%"=="0" (
    echo FIX R5: GAGAL dengan exit code %EXIT_CODE%
