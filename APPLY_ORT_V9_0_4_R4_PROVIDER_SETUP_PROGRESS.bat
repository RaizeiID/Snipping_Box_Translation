...
cd /d "%ORT_ROOT%"
set "PATCH_PY=%ORT_ROOT%\ORT\maintenance\apply_v9_0_4_r4_provider_setup_progress.py"
set "PY_EXE=%ORT_ROOT%\ORT_Runtime\.venv\Scripts\python.exe"
set "PYTHONUTF8=1"
set "PYTHONIOENCODING=utf-8"

echo ============================================================
echo  ORT v9.0.4 R4 - Provider Setup Progress and Status UI
echo ============================================================
...
echo.
echo ORT v9.0.4 R4 berhasil diterapkan.
pause
endlocal
