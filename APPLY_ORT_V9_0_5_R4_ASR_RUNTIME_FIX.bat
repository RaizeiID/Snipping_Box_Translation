...
setlocal
chcp 65001 >nul
title ORT v9.0.5 R4 - ASR Runtime Binding Fix

echo ============================================================
echo  ORT v9.0.5 R4 - ASR Runtime Binding Fix
echo ============================================================
echo.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0APPLY_ORT_V9_0_5_R4_ASR_RUNTIME_FIX.ps1"
