...
if not exist "%MIGRATOR%" (
  echo [ORT v9.0.0] Migrator tidak ditemukan. Terapkan ulang patch v9.0.0.
  pause
  exit /b 2
)
...
:run
echo ============================================================
echo  ORT v9.0.0 R1 - Clean Layout Migration / Repair
echo ============================================================
...
echo.
if exist "%ORT_ROOT%\ORT\maintenance\VERIFY_ORT_V9_0_0.bat" call "%ORT_ROOT%\ORT\maintenance\VERIFY_ORT_V9_0_0.bat"
echo.
