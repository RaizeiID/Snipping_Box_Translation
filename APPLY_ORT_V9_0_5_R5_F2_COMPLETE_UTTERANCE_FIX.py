...
PATCH_ID = "v9.0.5-R5-F2-COMPLETE-UTTERANCE-STREAMING"
MARKER = "ORT_R5_COMPLETE_UTTERANCE"

# R5-F1: Windows may keep stdout on cp1252 even after CHCP 65001.
...
'''
    ...
    # ORT R5-F2: The legacy self-test expected three rapid partials. R5
    # intentionally coalesces word-by-word updates into one or more meaningful
    # phrase updates, so one early partial plus one complete final is correct.
    text = text.replace(
...
def main() -> int:
    ...
    try:
        ...
        status_file = status_dir / "V9_0_5_R5_F2_COMPLETE_UTTERANCE.json"
        ...
        log("FIX SELESAI")
        print("ORT v9.0.5 R5-F2 Complete Utterance Streaming: PASS", flush=True)
