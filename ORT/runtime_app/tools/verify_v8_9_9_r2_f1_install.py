...
MANIFEST = PROJECT_ROOT / "SHA256SUMS_V8_9_9_R2_F1.txt"
...
def run_test(path: Path, timeout: int = 120) -> tuple[bool, str]:
...
def main() -> int:
    ...
    payload = {
        "passed": not errors,
        "version": "v8.9.9",
        "hotfix": "R2 F1 Hybrid Startup and Subtitle Continuity",
