...
cls
echo ============================================================
echo  ORT Translation v9.0.5 - START HERE
echo ============================================================
...
echo  [5] Buka dokumentasi v9.0.5
echo  [6] Export source ringan untuk dibagikan
echo  [7] Verifikasi instalasi v9.0.5
echo  [8] Keluar
echo ============================================================
...
:verify
if exist "%ORT_SUPPORT%\maintenance\VERIFY_ORT_V9_0_5.bat" call "%ORT_SUPPORT%\maintenance\VERIFY_ORT_V9_0_5.bat"
goto menu
