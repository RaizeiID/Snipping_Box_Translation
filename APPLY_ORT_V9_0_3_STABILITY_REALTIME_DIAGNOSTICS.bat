...
set "PATCH_PY=%ORT_ROOT%\ORT\maintenance\apply_v9_0_3_stability_realtime_diagnostics.py"
...
echo ============================================================
echo  ORT v9.0.3 - Stability Recovery ^& Realtime Diagnostics
echo ============================================================
...
if not "%PATCH_EXIT%"=="0" (
  echo.
  echo Update v9.0.3 gagal dengan exit code %PATCH_EXIT%.
...
echo.
echo Update ORT v9.0.3 berhasil.
echo Uji Preview realtime, log realtime, Efficient/Normal/Optimal, lalu upload source ke GitHub.
pause
endlocal
