...
cd /d "%ORT_ROOT%"
set "PATCH_PY=%ORT_ROOT%\ORT\maintenance\apply_v9_0_4_r4_f1_webui_startup.py"
set "PY_EXE=%ORT_ROOT%\ORT_Runtime\.venv\Scripts\python.exe"
set "PYTHONUTF8=1"
set "PYTHONIOENCODING=utf-8"

echo ============================================================
echo  ORT v9.0.4 R4 F1 - WebUI Startup NameError Repair
echo ============================================================
...
echo.
echo ORT v9.0.4 R4 F1 berhasil diterapkan.
pause
endlocal
